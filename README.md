# Issue Parser Frontend

## Boilerplate
The boilerplate we are using for this project can be found on [https://github.com/davezuko/react-redux-starter-kit](https://github.com/davezuko/react-redux-starter-kit)
...
```bash
$ git clone https://github.com/lambdaspace/issue_parser_frontend.git
